...
const Films = () => {
  ...
  return (
    <div className="bg-slate-100 dark:bg-slate-800 min-h-screen">
      <h2 className="text-4xl p-5 text-black dark:text-[#FFC107]">
        Films &#8594;
      </h2>
      {isLoading ? (
        <Loading />
  ...
  return (
    <div className="bg-white max-w-sm rounded-lg overflow-hidden shadow-lg m-4">
      <div className="px-6 py-4">
        ...
        <p className="text-gray-700 text-base mb-5">{opening_crawl}</p>
        <p className="text-gray-700 text-base">
          <strong>Director: </strong> {director}
        </p>
        <p className="text-gray-700 text-base">
          <strong>Producers: </strong> {producer}
        </p>
      </div>
      <div className="px-6 pt-4 pb-2">
        ...
        <span className="inline-block text-[#3d07ff] mb-4 mr-4"><a href="#">More Info.</a></span>
      </div>
    </div>
  );
};
